@echo off
REM ============================================================================
REM Build the SIL: compiles the EXACT flight firmware (..\Sysiphus_Landing.cpp)
REM together with the host harness, using g++ (MinGW-w64). See README.md to get a
REM compiler if "g++ is not recognized".
REM ============================================================================
g++ -std=c++17 -O2 -I shims -include shims/Arduino.h sim_main.cpp ..\Sysiphus_Landing.cpp -o sim.exe -lm
if errorlevel 1 (
  echo.
